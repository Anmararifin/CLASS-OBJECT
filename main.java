...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Mahasiswa.nama = "Muhanmar";
        Mahasiswa.nim = "D0217366";
        Mahasiswa.alamat = "palece";
        Mahasiswa.golonganDarah = "O";
        Mahasiswa.status = "Mahasiswa";
        Mahasiswa.tinggiBadan = "162";
        ...
        stack.value[0] = "Muhanmar";
        stack.value[1] = "lance";
        stack.value[2] = "lesly";
        stack.value[3] = "kaco";
        stack.value[4] = "kuci";
        stack.value[5] = "modu";
        stack.setValueAt(6, "ka");
